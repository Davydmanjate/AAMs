            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        @endif
                        <form action="{{url('layers.update')}}"  method = "post">
                            @csrf
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" name="category" class="form-control" id="category" placeholder="Categoria" value="{{$data->category}}">
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" name="address" class="form-control" id="address" placeholder="Morada" value="{{$data->address}}">
                            ...
                            <a href="{{url('layers.index')}}" class="btn btn-success">Back</a>
                        </form>
                    </div>
                </div>
            </div>
